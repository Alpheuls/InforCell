...
<div id="line-one">   
            <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <br>
                            ...
                            <span class="glyphicon glyphicon-plus"></span> Adicionar</button>
                                ...
                                onClick="window.open('/cliente/exibir','pagename',
                                'resizable,height=600,width=900')" id="color"> 
                                    <span class="glyphicon glyphicon-search"></span>
                                </button>
                                
                                <input type="text" name="clienteName" size ="40" 
                        ...
                        <div id="pesquisaProduto" class="pull-right">
                            <form class="form-group" method="post" 
                                  action="{{ route ('search.cliente')}}">
                                  {!! csrf_field() !!}   
                                <select name="tipy"  class="form-control input-sm pull-left" required>                                
                                <option value="price1">Consumidor Final</option>
                                <option value="price2">Lojista</option>
                                <option value="price3">Promoção</option>
                                </select>                                  
                            ...
                            <button class="btn btn-default btn-sm pull-right"   
                            onClick="window.open('/produto','pagename',
                                'resizable,height=600,width=900')"
                                        id="color">                                         
                                    <span class="glyphicon glyphicon-search"></span>
                                </button>
                        </div>                      
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br /><a href="{{route('truncate')}}" style='background-color:#ff1919' size='35'
